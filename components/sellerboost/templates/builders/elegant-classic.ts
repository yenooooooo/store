...
export function build(d: TemplateData): string {
  ...
  <div style="padding:72px 48px;text-align:center;background:#faf8f3;">
    <div style="width:32px;height:1px;background:#c4a35a;margin:0 auto 24px;"></div>
    ...
    <div style="width:32px;height:1px;background:#c4a35a;margin:24px auto 0;"></div>
  ...
  <div style="padding:40px 48px;">
    <div style="border:1px solid #d4c5a0;padding:36px;text-align:center;">
      <p style="font-size:12px;letter-spacing:4px;color:#c4a35a;margin:0 0 16px;">SOLUTION</p>
  ...
  <!-- Features: 번호 + 세리프 -->
  <div style="padding:40px 48px;border-top:1px solid #e8e2d6;">
    <p style="font-size:12px;letter-spacing:4px;color:#c4a35a;margin:0 0 32px;text-align:center;">FEATURES</p>
    ${d.features.map((f, i) => `<div style="display:flex;gap:20px;align-items:baseline;margin-bottom:24px;padding-bottom:24px;${i < d.features.length - 1 ? "border-bottom:1px solid #ece8df;" : ""}">
      <span style="font-size:24px;font-weight:300;color:#c4a35a;min-width:40px;text-align:right;font-family:Georgia,serif;">${String(i + 1).padStart(2, "0")}</span>
  ...
  <!-- Specs: 클래식 얇은 테이블 -->
  <div style="padding:40px 48px;">
    <p style="font-size:12px;letter-spacing:4px;color:#c4a35a;margin:0 0 24px;text-align:center;">DETAILS</p>
  ...
  <div style="padding:40px 48px;border-top:1px solid #e8e2d6;">
    <div style="max-width:560px;margin:0 auto;text-align:center;">
      <div style="color:#c4a35a;font-size:14px;margin-bottom:12px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
  ...
  ${d.faq.length > 0 ? `
  <div style="padding:40px 48px;border-top:1px solid #e8e2d6;">
    <p style="font-size:12px;letter-spacing:4px;color:#c4a35a;margin:0 0 28px;text-align:center;">FAQ</p>
  ...
  <div style="padding:56px 48px;text-align:center;background:#f5f0e8;border-top:1px solid #e8e2d6;">
    ...
    <div style="display:inline-block;border:1px solid #c4a35a;color:#c4a35a;padding:14px 48px;font-size:14px;font-weight:400;letter-spacing:2px;">PURCHASE NOW</div>
